...
public:
    ...
    ~udp_receiver_impl() noexcept = default;
    udp_receiver_impl( const udp_receiver_impl& ) = delete;
    udp_receiver_impl& operator=( const udp_receiver_impl& ) = delete;
    udp_receiver_impl( udp_receiver_impl&& ) noexcept;
    udp_receiver_impl& operator=( udp_receiver_impl&& ) noexcept;
